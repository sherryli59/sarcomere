...
int main(int argc, char* argv[]){
    ...
    try {
        ...
        options.add_options()
            ...
            ("myosin_radius_ratio", "Myosin radius ratio", cxxopts::value<double>(myosin_radius_ratio)->default_value("0.8"))
            ("crosslinker_length", "Crosslinker length", cxxopts::value<double>(crosslinker_length)->default_value("0.1"))
